...
const Navbar = () => {
    ...
    return (
        <header className="fixed w-full top-0 z-50 backdrop-blur-md bg-opacity-70 border-b border-white/10" style={{ backgroundColor: 'rgba(30, 22, 29, 0.7)' }}>
            ...
            {isOpen && (
                <section className="md:hidden glass-card mx-4 mt-2">
